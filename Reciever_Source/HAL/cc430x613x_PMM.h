//====================================================================
//    File: cc430x613x_PMM.h
//
//    This file is used in conjunction with cc430x613x_PMM.c to set 
//    the core voltage level of a device. To set a core voltage level, 
//    call SetVCore(level). See RF project(s) for example usage. 
// 
//    Version 1.0 first 
//    07/14/07
//
